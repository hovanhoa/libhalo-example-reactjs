...
async function execCredential(request, options) {
    ...
    console.log("options.compatibleCallMode", options.compatibleCallMode)
    ...
    // }
    let payload = Buffer.concat([Buffer.from([0x51])]);

    encodedRequest = new Uint8Array([0, 81, 0, 0]);
    ...
    console.log("u2fReq json", JSON.stringify(u2fReq))
    console.log("u2fReq", u2fReq)
